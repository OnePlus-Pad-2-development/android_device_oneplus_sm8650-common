...
ifneq($(BOARD_WLAN_CHIP),qca6750)
BOARD_VENDOR_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/modules.load.kiwi_v2)
else
BOARD_VENDOR_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/modules.load.qca6750)
endif
